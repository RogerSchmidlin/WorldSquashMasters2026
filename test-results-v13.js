...
const players=[
  ...
  player('Lynette Woodyard','Women',75),player('Wendy Ashley','Women',75),player('Nikki Mccullough','Women',75),player('Sharon Gilgallon','Women',75),
  player('Diane Moss','Women',70),player('Wendy Mcwilliams','Women',70)
];
...
const drawCatalog=[
 ...
 {href:'w75',text:"Women's +75"},{href:'w75b',text:"Women's +75 - Women's +75-3rd/4th",stageExtra:true}
];
const resultMatches=[
 ...
 // Women 70 main final. Dedicated playoff page contains TWO tiny placement
 // edges. The real 3rd/4th edge feeds output 1001; a later secondary edge
 // feeds 1002 and must NOT be selected just because it appears later.
 ...
 row('w70b','Pauline Douglas','Gaye Mitchell','Pauline Douglas',{a:'2001',b:'2002',o:'1001'},{order:44,date:'2026-09-06',time:'11:00'}),
 row('w70b','Diane Moss','Wendy Mcwilliams','Diane Moss',{a:'2003',b:'2004',o:'1002'},{order:99,date:'2026-09-06',time:'15:00'}),
 // Same dual-edge shape for Women 75.
 row('w75','Lynette Woodyard','Nikki Mccullough','Lynette Woodyard',{a:'3001',b:'3002',o:'2001'},{order:50}),
 row('w75','Wendy Ashley','Sharon Gilgallon','Wendy Ashley',{a:'3003',b:'3004',o:'2002'},{order:51}),
 row('w75','Lynette Woodyard','Wendy Ashley','Lynette Woodyard',{a:'2001',b:'2002',o:'1001'},{order:52}),
 row('w75b','Nikki Mccullough','Sharon Gilgallon','Nikki Mccullough',{a:'2001',b:'2002',o:'1001'},{order:53,date:'2026-09-06',time:'10:00'}),
 row('w75b','Melanie Knibbs','Michel Galloway','Melanie Knibbs',{a:'2003',b:'2004',o:'1002'},{order:100,date:'2026-09-06',time:'16:00'})
];
...
const drawSnapshots=[
 ...
 {drawUrl:'w70b',players:[{name:'Pauline Douglas',officialPlayerId:'Pauline Douglas'},{name:'Gaye Mitchell',officialPlayerId:'Gaye Mitchell'},{name:'Diane Moss',officialPlayerId:'Diane Moss'},{name:'Wendy Mcwilliams',officialPlayerId:'Wendy Mcwilliams'}]},
 {drawUrl:'w75b',players:[{name:'Nikki Mccullough',officialPlayerId:'Nikki Mccullough'},{name:'Sharon Gilgallon',officialPlayerId:'Sharon Gilgallon'},{name:'Melanie Knibbs',officialPlayerId:'Melanie Knibbs'},{name:'Michel Galloway',officialPlayerId:'Michel Galloway'}]}
];
const officialRows=[
...
const champions=[
 ...
 {key:'Women|75',playerName:'Lynette Woodyard'}
];
...
const cases=[
 ...
 ['Women',75,['Lynette Woodyard','Wendy Ashley','Nikki Mccullough','Sharon Gilgallon']],
...
console.log('RESULT SELECTOR V13 TESTS PASSED');
